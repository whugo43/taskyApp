...
/* harmony import */ var _guards_pendiente_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guards/pendiente.guard */ "./src/app/guards/pendiente.guard.ts");
...
const routes = [
    ...
    {
        path: 'registro',
        loadChildren: () => Promise.all(/*! import() | folder-registro-registro-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-registro-registro-module")]).then(__webpack_require__.bind(null, /*! ./folder/registro/registro.module */ "./src/app/folder/registro/registro.module.ts")).then(m => m.RegistroPageModule),
        canActivate: [_guards_no_login_guard__WEBPACK_IMPORTED_MODULE_3__["NoLoginGuard"]]
    },
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | folder-home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-home-home-module")]).then(__webpack_require__.bind(null, /*! ./folder/home/home.module */ "./src/app/folder/home/home.module.ts")).then(m => m.HomePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'cursos',
        loadChildren: () => Promise.all(/*! import() | folder-cursos-cursos-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-cursos-cursos-module")]).then(__webpack_require__.bind(null, /*! ./folder/cursos/cursos.module */ "./src/app/folder/cursos/cursos.module.ts")).then(m => m.CursosPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'curso-detalle/:id/:nombre',
        loadChildren: () => Promise.all(/*! import() | folder-curso-detalle-curso-detalle-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-curso-detalle-curso-detalle-module")]).then(__webpack_require__.bind(null, /*! ./folder/curso-detalle/curso-detalle.module */ "./src/app/folder/curso-detalle/curso-detalle.module.ts")).then(m => m.CursoDetallePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'publicaciones',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | folder-usuario-detalle-usuario-detalle-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-usuario-detalle-usuario-detalle-module")]).then(__webpack_require__.bind(null, /*! ./folder/usuario-detalle/usuario-detalle.module */ "./src/app/folder/usuario-detalle/usuario-detalle.module.ts")).then(m => m.UsuarioDetallePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'publicaciones-materia',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-publicaciones-materia-publicaciones-materia-module */ "folder-publicaciones-materia-publicaciones-materia-module").then(__webpack_require__.bind(null, /*! ./folder/publicaciones-materia/publicaciones-materia.module */ "./src/app/folder/publicaciones-materia/publicaciones-materia.module.ts")).then(m => m.PublicacionesMateriaPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'perfil-update',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | folder-crear-publicacion-crear-publicacion-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-crear-publicacion-crear-publicacion-module")]).then(__webpack_require__.bind(null, /*! ./folder/crear-publicacion/crear-publicacion.module */ "./src/app/folder/crear-publicacion/crear-publicacion.module.ts")).then(m => m.CrearPublicacionPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'mis-publicaciones',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-mis-publicaciones-mis-publicaciones-module */ "folder-mis-publicaciones-mis-publicaciones-module").then(__webpack_require__.bind(null, /*! ./folder/mis-publicaciones/mis-publicaciones.module */ "./src/app/folder/mis-publicaciones/mis-publicaciones.module.ts")).then(m => m.MisPublicacionesPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'curso-ayudantes/:id/:nombre',
        loadChildren: () => Promise.all(/*! import() | folder-curso-ayudantes-curso-ayudantes-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-curso-ayudantes-curso-ayudantes-module")]).then(__webpack_require__.bind(null, /*! ./folder/curso-ayudantes/curso-ayudantes.module */ "./src/app/folder/curso-ayudantes/curso-ayudantes.module.ts")).then(m => m.CursoAyudantesPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'curso-detalle-anuncio/:id',
        loadChildren: () => Promise.all(/*! import() | folder-curso-detalle-anuncio-curso-detalle-anuncio-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-curso-detalle-anuncio-curso-detalle-anuncio-module")]).then(__webpack_require__.bind(null, /*! ./folder/curso-detalle-anuncio/curso-detalle-anuncio.module */ "./src/app/folder/curso-detalle-anuncio/curso-detalle-anuncio.module.ts")).then(m => m.CursoDetalleAnuncioPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'pendiente',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-pendiente-pendiente-module */ "folder-pendiente-pendiente-module").then(__webpack_require__.bind(null, /*! ./folder/pendiente/pendiente.module */ "./src/app/folder/pendiente/pendiente.module.ts")).then(m => m.PendientePageModule),
    ...
    {
        path: 'mis-ayudantias',
        loadChildren: () => Promise.all(/*! import() | folder-mis-ayudantias-mis-ayudantias-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-mis-ayudantias-mis-ayudantias-module")]).then(__webpack_require__.bind(null, /*! ./folder/mis-ayudantias/mis-ayudantias.module */ "./src/app/folder/mis-ayudantias/mis-ayudantias.module.ts")).then(m => m.MisAyudantiasPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    // {
    ...
    {
        path: 'crear-ayudantia',
        loadChildren: () => Promise.all(/*! import() | folder-crear-ayudantia-crear-ayudantia-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-crear-ayudantia-crear-ayudantia-module")]).then(__webpack_require__.bind(null, /*! ./folder/crear-ayudantia/crear-ayudantia.module */ "./src/app/folder/crear-ayudantia/crear-ayudantia.module.ts")).then(m => m.CrearAyudantiaPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'mis-ayudantias-anuncios',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-mis-ayudantias-anuncios-mis-ayudantias-anuncios-module */ "folder-mis-ayudantias-anuncios-mis-ayudantias-anuncios-module").then(__webpack_require__.bind(null, /*! ./folder/mis-ayudantias-anuncios/mis-ayudantias-anuncios.module */ "./src/app/folder/mis-ayudantias-anuncios/mis-ayudantias-anuncios.module.ts")).then(m => m.MisAyudantiasAnunciosPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'solicitud-ayudantia',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-solicitud-ayudantia-solicitud-ayudantia-module */ "folder-solicitud-ayudantia-solicitud-ayudantia-module").then(__webpack_require__.bind(null, /*! ./folder/solicitud-ayudantia/solicitud-ayudantia.module */ "./src/app/folder/solicitud-ayudantia/solicitud-ayudantia.module.ts")).then(m => m.SolicitudAyudantiaPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'solicitud-materia',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-solicitud-materia-solicitud-materia-module */ "folder-solicitud-materia-solicitud-materia-module").then(__webpack_require__.bind(null, /*! ./folder/solicitud-materia/solicitud-materia.module */ "./src/app/folder/solicitud-materia/solicitud-materia.module.ts")).then(m => m.SolicitudMateriaPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'sugerencias',
        loadChildren: () => __webpack_require__.e(/*! import() | folder-sugerencias-sugerencias-module */ "folder-sugerencias-sugerencias-module").then(__webpack_require__.bind(null, /*! ./folder/sugerencias/sugerencias.module */ "./src/app/folder/sugerencias/sugerencias.module.ts")).then(m => m.SugerenciasPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'editar-publicacion/:id/:redireccion',
        loadChildren: () => Promise.all(/*! import() | folder-editar-publicacion-editar-publicacion-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-editar-publicacion-editar-publicacion-module")]).then(__webpack_require__.bind(null, /*! ./folder/editar-publicacion/editar-publicacion.module */ "./src/app/folder/editar-publicacion/editar-publicacion.module.ts")).then(m => m.EditarPublicacionPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'grupos/:id/:nombre',
        loadChildren: () => Promise.all(/*! import() | folder-grupos-grupos-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-grupos-grupos-module")]).then(__webpack_require__.bind(null, /*! ./folder/grupos/grupos.module */ "./src/app/folder/grupos/grupos.module.ts")).then(m => m.GruposPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'grupos-detalle/:id',
        loadChildren: () => Promise.all(/*! import() | folder-grupos-detalle-grupos-detalle-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-grupos-detalle-grupos-detalle-module")]).then(__webpack_require__.bind(null, /*! ./folder/grupos-detalle/grupos-detalle.module */ "./src/app/folder/grupos-detalle/grupos-detalle.module.ts")).then(m => m.GruposDetallePageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'crear-grupo/:id',
        loadChildren: () => Promise.all(/*! import() | folder-crear-grupo-crear-grupo-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-crear-grupo-crear-grupo-module")]).then(__webpack_require__.bind(null, /*! ./folder/crear-grupo/crear-grupo.module */ "./src/app/folder/crear-grupo/crear-grupo.module.ts")).then(m => m.CrearGrupoPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'crear-publicacion-todos',
        loadChildren: () => Promise.all(/*! import() | folder-crear-publicacion-todos-crear-publicacion-todos-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-crear-publicacion-todos-crear-publicacion-todos-module")]).then(__webpack_require__.bind(null, /*! ./folder/crear-publicacion-todos/crear-publicacion-todos.module */ "./src/app/folder/crear-publicacion-todos/crear-publicacion-todos.module.ts")).then(m => m.CrearPublicacionTodosPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'comentarios-usuario/:idMateria/:idAyudante',
        loadChildren: () => Promise.all(/*! import() | folder-comentarios-usuario-comentarios-usuario-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-comentarios-usuario-comentarios-usuario-module")]).then(__webpack_require__.bind(null, /*! ./folder/comentarios-usuario/comentarios-usuario.module */ "./src/app/folder/comentarios-usuario/comentarios-usuario.module.ts")).then(m => m.ComentariosUsuarioPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'mis-comentarios/:idMateria',
        loadChildren: () => Promise.all(/*! import() | folder-mis-comentarios-mis-comentarios-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-mis-comentarios-mis-comentarios-module")]).then(__webpack_require__.bind(null, /*! ./folder/mis-comentarios/mis-comentarios.module */ "./src/app/folder/mis-comentarios/mis-comentarios.module.ts")).then(m => m.MisComentariosPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
        path: 'detalle-publicidad/:id',
        loadChildren: () => Promise.all(/*! import() | folder-detalle-publicidad-detalle-publicidad-module */[__webpack_require__.e("common"), __webpack_require__.e("folder-detalle-publicidad-detalle-publicidad-module")]).then(__webpack_require__.bind(null, /*! ./folder/detalle-publicidad/detalle-publicidad.module */ "./src/app/folder/detalle-publicidad/detalle-publicidad.module.ts")).then(m => m.DetallePublicidadPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PendienteGuard", function() { return PendienteGuard; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var angularfire2_auth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angularfire2/auth */ "./node_modules/angularfire2/auth/index.js");
...
let PendienteGuard = class PendienteGuard {
    constructor(router, AFauth) {
        this.router = router;
        this.AFauth = AFauth;
    }
...
PendienteGuard.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: angularfire2_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"] }
];
PendienteGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], PendienteGuard);
...
let AuthService = class AuthService {
    ...
    signupnUser(email, password, nombre, apellido, matricula, telefono, fotoPerfil, fotoCarnet) {
        return new Promise((resolve, reject) => {
