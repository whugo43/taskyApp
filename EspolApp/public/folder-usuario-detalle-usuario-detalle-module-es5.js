(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["folder-usuario-detalle-usuario-detalle-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppFolderUsuarioDetalleUsuarioDetallePageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppFolderUsuarioDetalleUsuarioDetalleRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UsuarioDetallePageRoutingModule", function () {
        return UsuarioDetallePageRoutingModule;
      });
      /* harmony import */
      ...
      var _usuario_detalle_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var UsuarioDetallePageRoutingModule = function UsuarioDetallePageRoutingModule() {
        _classCallCheck(this, UsuarioDetallePageRoutingModule);
      };

      UsuarioDetallePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppFolderUsuarioDetalleUsuarioDetalleModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UsuarioDetallePageModule", function () {
      ...
      var _usuario_detalle_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./usuario-detalle-routing.module */
      "./src/app/folder/usuario-detalle/usuario-detalle-routing.module.ts");
      /* harmony import */


      var _usuario_detalle_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./usuario-detalle.page */
      "./src/app/folder/usuario-detalle/usuario-detalle.page.ts");

      var UsuarioDetallePageModule = function UsuarioDetallePageModule() {
        _classCallCheck(this, UsuarioDetallePageModule);
      };

      UsuarioDetallePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _usuario_detalle_routing_module__WEBPACK_IMPORTED_MODULE_5__["UsuarioDetallePageRoutingModule"]],
    ...
    /***/
    function srcAppFolderUsuarioDetalleUsuarioDetallePageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppFolderUsuarioDetalleUsuarioDetallePageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UsuarioDetallePage", function () {
      ...
      var src_app_models_ayudantes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/models/ayudantes */
      "./src/app/models/ayudantes.ts");
      /* harmony import */


      var src_app_models_calificaciones__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/models/calificaciones */
      ...
      var src_app_services_calificaciones_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/services/calificaciones.service */
      "./src/app/services/calificaciones.service.ts"); //import {EmailComposer, EmailComposerOptions} from "@ionic-native/email-composer/ngx";


      var UsuarioDetallePage = /*#__PURE__*/function () {
        function UsuarioDetallePage(activateRoute, usuarioService, ayudantesService, calificacionesService) {
          _classCallCheck(this, UsuarioDetallePage);
        ...
        _createClass(UsuarioDetallePage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.activateRoute.paramMap.subscribe(function (paramMap) {
              ...
              var idMateria = paramMap.get('idMateria');
              _this.idMateria = idMateria;
              _this.id = idUsuario;

              _this.usuarioService.getUsuario(idUsuario).subscribe(function (res) {
                _this.usuario = res;
              }); // this.actividadService.getActividad(idActividad).subscribe(res => this.actividad =res);

            });
            this.ayudantesService.getAyudantes().subscribe(function (res) {
              _this.ayudantes = res;
            });
            this.calificacionesService.getCalificaciones().subscribe(function (res) {
          ...
          key: "like",
          value: function like() {
            var ayudante = new src_app_models_ayudantes__WEBPACK_IMPORTED_MODULE_4__["Ayudantes"]();
            ...
            for (var index = 0; index < this.ayudantes.length; index++) {
              if (this.ayudantes[index].Materia == this.idMateria && this.ayudantes[index].Usuario == this.id) {
                ...
                var calificacion = new src_app_models_calificaciones__WEBPACK_IMPORTED_MODULE_5__["Calificaciones"]();
            ...
            this.click = true; //this.controlar();
          }
        }, {
          key: "dislike",
      ...
      UsuarioDetallePage.ctorParameters = function () {
        return [{
      ...
      UsuarioDetallePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-usuario-detalle',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./usuario-detalle.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/folder/usuario-detalle/usuario-detalle.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./usuario-detalle.page.scss */
        "./src/app/folder/usuario-detalle/usuario-detalle.page.scss"))["default"]]
      })], UsuarioDetallePage);
      /***/
    },
    ...
    /***/
    function srcAppModelsCalificacionesTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "Calificaciones", function () {
        return Calificaciones;
      });

      var Calificaciones = function Calificaciones() {
        _classCallCheck(this, Calificaciones);
      };
      /***/
    ...
    /***/
    function srcAppServicesCalificacionesServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CalificacionesService", function () {
      ...
      var CalificacionesService = /*#__PURE__*/function () {
        function CalificacionesService(firestore) {
          _classCallCheck(this, CalificacionesService);
        ...
        _createClass(CalificacionesService, [{
      ...
      CalificacionesService.ctorParameters = function () {
        return [{
          type: angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
        }];
      };

      CalificacionesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
...
//# sourceMappingURL=folder-usuario-detalle-usuario-detalle-module-es5.js.map